...
go get -insecure -u github.com/SwordJason/v2ray-core/...
go build -o $GOPATH/bin/v2ray github.com/SwordJason/v2ray-core/main
go build -o $GOPATH/bin/v2ctl github.com/SwordJason/v2ray-core/infra/control/main
