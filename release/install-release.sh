...
# Original source is located at github.com/SwordJason/v2ray-core/release/install-release.sh
...
downloadV2Ray(){
    ...
    if [[ "${DIST_SRC}" == "jsdelivr" ]]; then
        ...
        DOWNLOAD_LINK="https://github.com/SwordJason/v2ray-core/releases/download/${NEW_VER}/v2ray-linux-${VDIS}.zip"
    fi
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/SwordJason/v2ray-core/releases/latest"
